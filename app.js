(() => {
  ...
  const imageAssets = {
    cultureCamp: "camp-teacher-circle.png",
    lessonLibrary: "library-student-tablet.png",
    teacherCircle: "library-teacher-circle.png",
    goalChart: "library-goal-chart.png",
    progress: "progress-celebration.png",
    constellation: "constellation-classroom.png"
  };
  ...
  const resources = [
    { id: "camp-kit", title: "Session 1 Master Complete Production Build", type: "Final DOCX", cluster: "BOY Culture Build", value: "Safe", path: "resources/camp-kit.docx", desc: "Final staff-facing production build for Session 1.", tags: ["final draft", "session 1", "staff"] },
    { id: "teacher-guide", title: "Session 1 Facilitator Guide - Revised", type: "Final DOCX", cluster: "BOY Culture Build", value: "Responsible", path: "resources/teacher-guide.docx", desc: "Revised facilitator guide for running Session 1.", tags: ["final draft", "facilitator"] },
    { id: "complete-arc", title: "Session 1 Complete Production Index", type: "Final DOCX", cluster: "BOY Culture Build", value: "Responsible", path: "resources/complete-arc.docx", desc: "Index of the final Session 1 production set.", tags: ["index", "final set"] },
    { id: "alignment-map", title: "Session 1 Alignment Map", type: "Final DOCX", cluster: "BOY Culture Build", value: "Safe", path: "resources/alignment-map.docx", desc: "Start-here alignment map for the finalized Session 1 package.", tags: ["start here", "alignment"] },
    { id: "participant-workbook", title: "Session 1 Participant Workbook", type: "Final DOCX", cluster: "BOY Culture Build", value: "Respectful", path: "resources/participant-workbook.docx", desc: "Participant workbook for teacher-facing training.", tags: ["workbook", "staff"] },
    { id: "day10", title: "Session 1 Implementation Assignment", type: "Final DOCX", cluster: "BOY Culture Build", value: "Responsible", path: "resources/day10.docx", desc: "Teacher implementation assignment after Session 1.", tags: ["assignment", "implementation"] },
    { id: "fidelity", title: "Session 1 Follow-Up Coaching Look-For", type: "Final DOCX", cluster: "Coaching", value: "Responsible", path: "resources/fidelity.docx", desc: "Final coaching look-for connected to Session 1 implementation.", tags: ["coaching", "look-for"] },
    { id: "practice-bank", title: "CAR Responsive Move Quick Guide", type: "Final DOCX", cluster: "Teacher Tools", value: "Responsible", path: "resources/practice-bank.docx", desc: "Quick guide for the CAR responsive move.", tags: ["quick guide", "CAR"] },
    { id: "message-board", title: "Day 1 CAR Wall Build Protocol", type: "Final DOCX", cluster: "Teacher Tools", value: "Respectful", path: "resources/message-board.docx", desc: "Final protocol for building the Day 1 CAR wall.", tags: ["protocol", "wall build"] },
    { id: "station-materials", title: "Session 1 Station Materials and Facilitator Key", type: "Final DOCX", cluster: "Teacher Tools", value: "Respectful", path: "resources/station-materials.docx", desc: "Station materials with facilitator key for Session 1.", tags: ["stations", "facilitator"] },
    { id: "qr-forms", title: "Session 1 QR Form Templates", type: "Final DOCX", cluster: "Teacher Tools", value: "Responsible", path: "resources/qr-forms.docx", desc: "Final QR form templates for Session 1 implementation.", tags: ["forms", "QR"] },
    { id: "student-sequence", title: "Safe Respectful Responsible Promise - Student Resources", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/student-sequence.docx", desc: "Final student resources and handouts for the culture promise lesson.", tags: ["student", "promise"] },
    { id: "culture-promise-teacher", title: "Safe Respectful Responsible Promise - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/culture-promise-teacher.docx", desc: "Final teacher guide for the culture promise lesson.", tags: ["teacher guide", "promise"] },
    { id: "culture-promise-35-plan", title: "Culture Promise Grades 3-5 Lesson Plan", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/culture-promise-35-plan.docx", desc: "Final revised Grades 3-5 lesson plan for the culture promise.", tags: ["3-5", "lesson plan"] },
    { id: "culture-promise-35-handout", title: "Culture Promise Grades 3-5 Handout and Visuals", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/culture-promise-35-handout.docx", desc: "Final revised Grades 3-5 handout and visuals for the culture promise.", tags: ["3-5", "handout"] },
    { id: "speech-frames", title: "Behavior Matrix by Grade Band - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Respectful", path: "resources/speech-frames.docx", desc: "Final teacher guide for the behavior matrix by grade band lesson.", tags: ["teacher guide", "behavior matrix"] },
    { id: "behavior-matrix-35-plan", title: "Behavior Matrix Grades 3-5 Lesson Plan", type: "Final DOCX", cluster: "Student Lessons", value: "Respectful", path: "resources/behavior-matrix-35-plan.docx", desc: "Final revised Grades 3-5 behavior matrix lesson plan.", tags: ["3-5", "lesson plan"] },
    { id: "first-five", title: "First Five Routine - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/first-five.docx", desc: "Final teacher guide for the First Five routine.", tags: ["teacher guide", "First Five"] },
    { id: "first-five-35-plan", title: "First Five Grades 3-5 Lesson Plan", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/first-five-35-plan.docx", desc: "Final revised Grades 3-5 First Five lesson plan.", tags: ["3-5", "lesson plan"] },
    { id: "first-five-35-handout", title: "First Five Grades 3-5 Handout and Visuals", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/first-five-35-handout.docx", desc: "Final revised Grades 3-5 First Five handout and visuals.", tags: ["3-5", "handout"] },
    { id: "breakfast", title: "Breakfast Holding Routine - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/breakfast.docx", desc: "Final teacher guide for breakfast holding routine.", tags: ["teacher guide", "routine"] },
    { id: "hallway", title: "Hallway Travel Routine - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Respectful", path: "resources/hallway.docx", desc: "Final teacher guide for hallway travel routine.", tags: ["teacher guide", "hallway"] },
    { id: "bathroom", title: "Bathroom Routine - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Responsible", path: "resources/bathroom.docx", desc: "Final teacher guide for bathroom routine.", tags: ["teacher guide", "bathroom"] },
    { id: "cafeteria", title: "Cafeteria Entry, Meal, Exit - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Respectful", path: "resources/cafeteria.docx", desc: "Final teacher guide for cafeteria routine.", tags: ["teacher guide", "cafeteria"] },
    { id: "recess", title: "Recess Boundaries and Recall - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/recess.docx", desc: "Final teacher guide for recess boundaries and recall.", tags: ["teacher guide", "recess"] },
    { id: "independent-work", title: "Independent Work Norms - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Responsible", path: "resources/independent-work.docx", desc: "Final teacher guide for independent work norms.", tags: ["teacher guide", "independent work"] },
    { id: "reset-scripts", title: "Regulation Choices - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Safe", path: "resources/reset-scripts.docx", desc: "Final teacher guide for regulation choices.", tags: ["teacher guide", "regulation"] },
    { id: "repair-scripts", title: "Repair Words - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Responsible", path: "resources/repair-scripts.docx", desc: "Final teacher guide for repair words.", tags: ["teacher guide", "repair"] },
    { id: "reteach", title: "Re-Entry Routine - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Responsible", path: "resources/reteach.docx", desc: "Final teacher guide for re-entry routine.", tags: ["teacher guide", "re-entry"] },
    { id: "adult-look-fors", title: "Adult Look-Fors for Students - Teacher Guide", type: "Final DOCX", cluster: "Student Lessons", value: "Responsible", path: "resources/adult-look-fors.docx", desc: "Final teacher guide for explaining adult look-fors to students.", tags: ["teacher guide", "look-fors"] },
    { id: "morning-manual", title: "Morning Meeting Culture Lab Training Deck", type: "Final HTML", cluster: "Slide Decks", value: "Safe", path: "resources/morning-manual.html", desc: "Final editable HTML training deck for Morning Meeting Culture Lab.", tags: ["deck", "Morning Meeting"] },
    { id: "morning-minute", title: "Morning Meeting - The Matchbook Way", type: "Final HTML", cluster: "Slide Decks", value: "Safe", path: "resources/morning-minute.html", desc: "Short final all-staff intro deck for Morning Meeting.", tags: ["deck", "all-staff"] },
    { id: "culture-deck", title: "Culture Camp Launch Deck", type: "Final HTML", cluster: "Slide Decks", value: "Safe", path: "resources/culture-deck.html", desc: "Final editable HTML deck for launching Culture Camp.", tags: ["deck", "Culture Camp"] },
    { id: "teacher-deck", title: "Teacher Training Deck", type: "Final HTML", cluster: "Slide Decks", value: "Responsible", path: "resources/teacher-deck.html", desc: "Final editable HTML teacher training deck.", tags: ["deck", "teacher"] },
    { id: "role-system", title: "Student Leader Training Deck", type: "Final HTML", cluster: "Slide Decks", value: "Responsible", path: "resources/role-system.html", desc: "Final editable HTML student leader training deck.", tags: ["deck", "student leadership"] },
    { id: "data-tracker", title: "App Data Architecture Deck", type: "Final HTML", cluster: "Data", value: "Responsible", path: "resources/data-tracker.html", desc: "Final editable HTML deck for the app and data architecture.", tags: ["deck", "data"] },
    { id: "response-pathway", title: "Responsive Behavior Plan Training Deck", type: "Final HTML", cluster: "Responsive Behavior", value: "Safe", path: "resources/response-pathway.html", desc: "Final editable HTML training deck for responsive behavior.", tags: ["deck", "responsive behavior"] },
    { id: "repair-framework", title: "Restorative Repair Training Deck", type: "Final HTML", cluster: "Repair", value: "Responsible", path: "resources/restorative-deck.html", desc: "Final editable HTML training deck for restorative repair.", tags: ["deck", "repair"] },
    { id: "restorative-deck", title: "Restorative Repair Training Deck", type: "Final HTML", cluster: "Repair", value: "Responsible", path: "resources/restorative-deck.html", desc: "Final restorative repair deck for teacher and staff reference.", tags: ["deck", "repair"] },
    { id: "cypher-guide", title: "Friday Cypher Training Deck", type: "Final HTML", cluster: "Recognition", value: "Respectful", path: "resources/recognition-guide.html", desc: "Final editable HTML training deck for Friday Cypher.", tags: ["deck", "recognition"] },
    { id: "nomination-protocol", title: "Friday Cypher Training Deck", type: "Final HTML", cluster: "Recognition", value: "Responsible", path: "resources/recognition-guide.html", desc: "Final deck section for evidence-based Friday Cypher nomination practice.", tags: ["deck", "nomination"] },
    { id: "recognition-guide", title: "Friday Cypher Training Deck", type: "Final HTML", cluster: "Recognition", value: "Respectful", path: "resources/recognition-guide.html", desc: "Final deck for recognition through evidence.", tags: ["deck", "recognition"] },
    { id: "family-evidence", title: "Family Connection Wheel Training Deck", type: "Final HTML", cluster: "Family Connection", value: "Respectful", path: "resources/family-evidence.html", desc: "Final editable HTML deck for the Family Connection Wheel.", tags: ["deck", "family"] },
    { id: "director-playbook", title: "Director of Culture Playbook", type: "Final PDF", cluster: "Current Playbooks", value: "Responsible", path: "resources/director-playbook.pdf", desc: "Current adult culture operating playbook.", tags: ["current", "playbook"] },
    { id: "operations-manual", title: "Campus Culture Operations Manual", type: "Final PDF", cluster: "Current Playbooks", value: "Safe", path: "resources/operations-manual.pdf", desc: "Current campus culture operations manual for 2026-2027.", tags: ["current", "operations"] },
    { id: "restorative-counselor", title: "Restorative and Counselor Playbook", type: "Final PDF", cluster: "Current Playbooks", value: "Respectful", path: "resources/restorative-counselor.pdf", desc: "Current restorative and counselor operating playbook.", tags: ["current", "restore"] },
    { id: "family-handbook", title: "Parent and Student Handbook", type: "Final HTM", cluster: "Current Playbooks", value: "Safe", path: "resources/family-handbook.htm", desc: "Current parent and student handbook print document.", tags: ["current", "handbook"] }
  ];
  ...
  function renderLibrary() {
    ...
    filtered.forEach(resource => {
      ...
      thumb.innerHTML = `<img src="./assets/${resourceImage(resource)}" alt=""><span>${docType}</span><strong>${resource.cluster}</strong><i></i><i></i><i></i>`;
